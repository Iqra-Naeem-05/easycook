...
def chef_picture_upload_path(instance, filename):
    """
    Sets upload path for each chef's profile picture.
    - Stored in: /media/chef_profiles/<chef_id>/profile_picture.<extension>
    """
...
class ChefProfile(models.Model):
    ...
    specialties = models.CharField(max_length=255, blank=True, null=True)  # Example: "Italian, BBQ"
    ...
    # Rating fields
    average_rating = models.FloatField(default=0)  # Store average rating
    total_ratings = models.IntegerField(default=0)  # Store total number of ratings
