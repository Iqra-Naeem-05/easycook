...
urlpatterns = [
    # Authorization
    path("register/", views.register_user, name="register"),  # URL for registration
    path("login/", views.login_user, name="login"),
    path('change-password/', views.change_password, name='change-password'),
    path("user-info/", views.user_info, name="user_info"),
    path("logout/", views.logout_user, name="logout"),
    # path("get-user/", views.get_user, name="get-user"),
    # path("csrf-token/", views.get_csrf_token, name="csrf_token"),  # CSRF Token endpoint
    ...
    # path('chef-dishes/<int:chef_id>/', views.chef_dishes, name='chef_dish'),
