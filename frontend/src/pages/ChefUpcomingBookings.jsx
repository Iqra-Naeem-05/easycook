...
// import BookingCard from '../components/UserBookings/BookingCard';  // Reusing the same card
...
//             // try {
//             //     const response = await axios.get('/chef-upcoming-bookings/');  // (Make sure this API returns chef’s bookings)
...
//             // }
//              try {
//                     const response = await axios.get('/chef-upcoming-bookings/');
