...
//           setNextPageUrl(response.data.next);
//         })
//         .catch(error => console.error("Error loading more chefs:", error));
//     }
//   };
...
//           <button onClick={loadMore} className="btn btn-outline-brown">
//             See More
//           </button>
//         </div>
//       )}
...
const ChefsList = () => {
  ...
  const totalPages = Math.ceil(count / 8); // Assuming 8 chefs per page
