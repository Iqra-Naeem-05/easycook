...
const AppRoutes = () => {
  return (
    <Routes>
      ...
      {/* <Route path="/chef-profile" element={<PrivateRoute><MainLayout><ChefProfile /></MainLayout></PrivateRoute>} /> */}
      ...
      {/* <Route path="/dish-list/:chefId"  element={ <PrivateRoute allowedRoles={["chef"]}> <MainLayout><DishList /></MainLayout> </PrivateRoute> } /> */}
      ...
      {/* <Route path="/chef-upcoming-bookings" element={<MainLayout><ChefUpcomingBookings /></MainLayout>} /> */}
